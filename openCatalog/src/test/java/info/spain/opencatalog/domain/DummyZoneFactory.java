...
public class DummyZoneFactory extends AbstractFactory {
	...
	public static final Zone ZONE_NORTE  = DummyZoneFactory.newZone("Norte de España").setPath( ImmutableList.of(
	...
	public static final Zone ZONE_MADRID_CENTRO  = DummyZoneFactory.newZone("Madrid").setPath( ImmutableList.of(
	...
	public static final Zone ZONE_ALCALA_HENARES = DummyZoneFactory.newZone("Alcala de Henares").setPath( ImmutableList.of(
	...
	public static final Zone ZONE_PROVINCIA_STA_CRUZ = DummyZoneFactory.newZone("Santa Cruz de Tenerife").setPath( ImmutableList.of(
	...
	public static final Zone ZONE_COMPLEX = DummyZoneFactory.newZone("Complex Zone").setPath( ImmutableList.of(
	...
	public static final Zone ZONE_EMPTY = DummyZoneFactory.newZone("Zone without POIS").setPath( ImmutableList.of(
