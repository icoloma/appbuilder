...
, findByKeyword = function(keyword) {
  return _.find(types, function(type) {
    return type._keyword_dev === keyword;
  }).id;
}
;
...
module.exports = function(pois) {
  return {
    ...
    searchCategories: {
      "9C8A05F4964F41FFB51E2AE8B109CA85": {
        "id": "9C8A05F4964F41FFB51E2AE8B109CA85",
        "label_en": "Places to see",
      ...
      "2F47BDF3A6C8406E8C27F4FF7DFEBDDF": {
        "id": "2F47BDF3A6C8406E8C27F4FF7DFEBDDF",
        "label_en": "Places to sleep",
      ...
      "9E649E7DD6A046298DFC48A01D9B4E47": {
        "id": "9E649E7DD6A046298DFC48A01D9B4E47",
        "label_en": "Places to do something",
